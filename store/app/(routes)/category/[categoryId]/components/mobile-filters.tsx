...
const MobileFilters: React.FC<MobileFiltersProps> = ({ sizes, colors }) => {
    // 1. خلي الـ open بـ false عشان ميبدأش مفتوح ويعمل قفلة
    const [open, setOpen] = useState(false);
    
    // 2. ضفنا state للتأكد إن الـ Component بقى موجود في المتصفح
    ...
    // 3. لو لسه مخلصش الـ mount ميرسمش حاجة عشان نمنع الـ Hydration Error
    if (!isMounted) {
        return null;
    }
