    ...
    return (
        ...
        <div className="absolute top-0 inset-x-0 z-50 flex justify-center px-4 sm:px-8 py-4 sm:py-8">
            <div className="w-full max-w-7xl flex items-center justify-between transition-all duration-300">
                ...
                <Link href="/" className="flex items-center gap-x-6 transition-all duration-300 hover:opacity-80 group">
                    <div className="relative h-12 w-12 sm:h-14 sm:w-14 transition-transform duration-500 group-hover:scale-110">
                        <Image
                            src="/logo-final.png"
                            alt="Dozy Signature"
                            fill
                    ...
                    <p className="font-serif italic text-3xl sm:text-4xl uppercase tracking-[0.5em] hidden lg:block text-[#d4af37] drop-shadow-[0_0_15px_rgba(212,175,55,0.4)] transition-all duration-500 group-hover:tracking-[0.6em]">
                        Dozy
                    </p>
                </Link>
