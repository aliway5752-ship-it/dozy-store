...
import { Textarea } from '@/components/ui/textarea'; // تأكد من وجود المكون ده عندك
...
const formSchema = z.object({
    ...
    description: z.string().min(1), // حقل الوصف
    stock: z.coerce.number().min(0)  // حقل الاستوك
})
...
export const ProductForm: React.FC<ProductFromProps> = ({
    ...
    const form = useForm<ProductFormValues>({
        ...
        defaultValues: initialData ? {
            ...
            description: initialData?.description || '', // قيمة افتراضية للوصف
            stock: initialData?.stock || 0, // قيمة افتراضية للاستوك
        } : {
            name: '',
            images: [],
            price: 0,
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea disabled={loading} placeholder='Detailed description of the product...' {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
